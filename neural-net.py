...
# As i change the number of hidden layers from 1 to 10. There is no obvious change reflecting in the training and
# testing error.
# Here i print the mean of the error and also the last one in the each epoch.
